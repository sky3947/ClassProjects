...
class Agent(object):
    ...
    def decide(self):
        ...
        can decide what actions to take to survive. In this version,
        we will only shoot from our center-ish point and aim as well
        as we can at the closest asteroid
        """
        ...
        # If firing is on cooldown, turn towards the closest asteroid
            ...
            if self.turn_frames != target_frame:
                ...
                if ang_difference > 0:
                    ...
                    #print("Decided to turn right in attempt to rotate towards asteroid " + str(self.turn_frames))
                    return RIGHT
                else:
                    self.turn_frames -= FRAME_UNIT
                    self.update_turn_frames()
                    #print("Decided to turn left in attempt to rotate towards asteroid " + str(self.turn_frames))
                    return LEFT
